...
func TestRecipesListsAndFilters(t *testing.T) {
	...
	// debian satisfies xfce, devtools, docker, python-dev, build-deps, pkg-tools, and tailscale OS lists.
	...
	want := map[string]bool{"xfce": true, "devtools": true, "docker": true, "python-dev": true, "tailscale": true, "build-deps": true, "pkg-tools": true}
