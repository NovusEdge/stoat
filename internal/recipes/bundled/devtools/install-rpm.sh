...
# dnf guest: Fedora, AlmaLinux or Rocky.
#
# EL9 ships no package named vim; vim-enhanced provides it, and dnf resolves
# the name through that. Verified on AlmaLinux 9.8.
set -e

stoat_pkg_setup
stoat_pkg_install git curl ca-certificates gcc make vim tmux less bash
